...
<html lang="es">
  <head>
    ...
    <body> 
      <main class="homeNino">
        <div id="particles-js" class="particulas"></div>
        <div id="particles-js2" class="particulas"></div>
        <div id="particles-js3" class="particulas"></div>
        <div id="particles-js4" class="particulas"></div>
        <section class="homeNino--hero">
